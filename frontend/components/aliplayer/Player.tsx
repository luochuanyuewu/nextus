...
import type { PlayerProps, PlayerConfig, PlayerInstance, PlayerRef } from './types';
...
const InternalPlayer: React.ForwardRefRenderFunction<PlayerRef, PlayerProps> = (props, ref) => {
    const {
    ...
    const insertScriptTag = () => {
        let playerScriptTag = document.getElementById(playerScriptId) as HTMLScriptElement;
