...
export interface ApiGameConfigGameConfig extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    config: JSONAttribute & RequiredAttribute;
    name: StringAttribute;
...
export interface ApiGameListGameList extends CollectionTypeSchema {
  info: {
...
export interface ApiGameSessionGameSession extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    game: StringAttribute & RequiredAttribute & UniqueAttribute;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    publishedAt: DateTimeAttribute;
    createdBy: RelationAttribute<
